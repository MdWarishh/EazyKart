  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-screen text-center p-6'>
       ...
       >
        ...
        <h1 className='text-4xl md:text-5xl font-extrabold text-green-700'>Lazykart</h1>
       </motion.div>
       ...
       className='mt-4 test-gray-700 text-lg md:text-xl max-w-lg'
       >
        Your one-stop destination for fresh groceries,organic product and daily essentials. Delivered to your doorstep with care and convenience.
       </motion.p>
